    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('room_number', models.IntegerField(default=1, verbose_name='количество комнат')),
                ('price', models.DecimalField(decimal_places=2, max_digits=10, verbose_name='цена')),
                ('phone_number', models.CharField(max_length=80, verbose_name='номер телефона')),
                ('realty_type', models.CharField(choices=[('АРЕНДА', 'Аренда'), ('ПРОДАЖА', 'Продажа'), ('ПОКУПКА', 'Покупка')], default='ПРОДАЖА', max_length=10, verbose_name='вид приобретение')),
                ...
                ('commentary', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='posts', to='posts.commentary', verbose_name='комментарий')),
            ],
            options={
                'verbose_name': 'Пост',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('photo', models.FileField(upload_to='post_images/%Y/%m/%d/', verbose_name='рисунок')),
        ...
        migrations.AddField(
            model_name='post',
            name='post_image',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='posts', to='posts.postimage', verbose_name='рисунок'),
        ),
    ]
